...
export default function Sidebar() {
  ...
  const handleLogoutConfirm = () => {
    // Clear any auth tokens, session data, etc.
    // For example:
  ...
  return (
    <>
      <aside className="fixed left-0 top-0 pt-4 h-screen w-[108px] bg-white border-r border-[#F3F4F6] flex flex-col">
        ...
        {/* Logout - using button instead of Link */}
        <button
          onClick={handleLogoutClick}
          className="flex flex-col items-center justify-center gap-1 py-3 px-2 text-[#000] hover:text-[#219e02] transition-colors duration-200"
        >
