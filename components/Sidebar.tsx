...
export default function Sidebar({ mobileOpen = false, onMobileClose }: SidebarProps) {
    ...
    <>
      ...
      >
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive ? "text-[#219e02]" : "text-[#000] hover:text-[#219e02]"}
                `}
              >
                {isActive && (
        ...
        >
          ...
          <span className="text-[12px] font-medium text-center leading-6">Settings</span>
        </Link>
        ...
        >
          ...
          <span className="text-[12px] font-medium text-center leading-6">Log out</span>
        </button>
      </div>
    </>
  );
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex fixed left-0 top-0 pt-4 h-screen w-[108px] bg-white border-r border-[#F3F4F6] flex-col z-50">
        {navContent}
      </aside>
      ...
      <aside
        className={`
          fixed left-0 top-0 pt-4 h-screen w-[108px] bg-white border-r border-[#F3F4F6] flex flex-col z-50
      ...
      >
        ...
        <button
          onClick={onMobileClose}
          className="absolute top-3 right-2 p-1.5 hover:bg-gray-100 rounded-lg transition-colors"
        >
